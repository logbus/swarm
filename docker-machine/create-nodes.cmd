...
#docker-machine create --driver hyperv --hyperv-virtual-switch "swarm" --hyperv-memory 1024 --hyperv-cpu-count 1 --hyperv-disk-size 10000 node04
#docker-machine create --driver hyperv --hyperv-virtual-switch "swarm" --hyperv-memory 1024 --hyperv-cpu-count 1 --hyperv-disk-size 10000 node05
docker-machine create --driver hyperv --hyperv-virtual-switch "swarm" --hyperv-memory 1024 --hyperv-cpu-count 1 --hyperv-disk-size 10000 node06